...
public class VFSIndexer {
     ...
     * @throws IOException
     */
    public VFSIndexer(String indexUri) throws IOException {
        //得到索引所在目录的路径
        Directory directory = new VFSDirectory(indexUri);
        // 标准分词器
    ...
    public static void main(String[] args) throws IOException {
        ...
        VFSIndexer indexer = null;
        Scanner scanner = new Scanner(System.in);
        while (true) {
            try {
                String cmd = scanner.next();
                indexer = new VFSIndexer(indexDir);
                switch (cmd) {
                    case "c":
